...
namespace Ajuna.NetApi.Model.PalletCollective
{
    ...
    public sealed class Votes : BaseType
    {
        ...
        /// >> ayes
        /// </summary>
        private BaseVec<Ajuna.NetApi.Model.SpCore.AccountId32> _ayes;
        
        /// <summary>
        /// >> nays
        /// </summary>
        private BaseVec<Ajuna.NetApi.Model.SpCore.AccountId32> _nays;
        ...
        public BaseVec<Ajuna.NetApi.Model.SpCore.AccountId32> Ayes
        {
            get
            {
                return this._ayes;
        ...
        public BaseVec<Ajuna.NetApi.Model.SpCore.AccountId32> Nays
        {
            get
            {
                return this._nays;
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Ayes = new BaseVec<Ajuna.NetApi.Model.SpCore.AccountId32>();
            Ayes.Decode(byteArray, ref p);
            Nays = new BaseVec<Ajuna.NetApi.Model.SpCore.AccountId32>();
