...
namespace Ajuna.NetApi.Model.PalletDemocracy
{
    ...
    public sealed class ReferendumStatus : BaseType
    {
        ...
        /// >> proposal_hash
        /// </summary>
        private Ajuna.NetApi.Model.PrimitiveTypes.H256 _proposalHash;
        
        /// <summary>
        /// >> threshold
        /// </summary>
        private Ajuna.NetApi.Model.PalletDemocracy.EnumVoteThreshold _threshold;
        ...
        /// >> tally
        /// </summary>
        private Ajuna.NetApi.Model.PalletDemocracy.Tally _tally;
        ...
        public Ajuna.NetApi.Model.PrimitiveTypes.H256 ProposalHash
        {
            get
            {
        ...
        public Ajuna.NetApi.Model.PalletDemocracy.EnumVoteThreshold Threshold
        {
            get
            {
        ...
        public Ajuna.NetApi.Model.PalletDemocracy.Tally Tally
        {
            get
            {
                return this._tally;
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            ProposalHash = new Ajuna.NetApi.Model.PrimitiveTypes.H256();
            ProposalHash.Decode(byteArray, ref p);
            Threshold = new Ajuna.NetApi.Model.PalletDemocracy.EnumVoteThreshold();
            Threshold.Decode(byteArray, ref p);
            Delay = new Ajuna.NetApi.Model.Types.Primitive.U32();
            Delay.Decode(byteArray, ref p);
            Tally = new Ajuna.NetApi.Model.PalletDemocracy.Tally();
