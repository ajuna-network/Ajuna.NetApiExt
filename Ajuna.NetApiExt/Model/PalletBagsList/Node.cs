...
namespace Ajuna.NetApi.Model.PalletBagsList
{
    ...
    public sealed class Node : BaseType
    {
        ...
        /// >> id
        /// </summary>
        private Ajuna.NetApi.Model.SpCore.AccountId32 _id;
        
        /// <summary>
        /// >> prev
        /// </summary>
        private BaseOpt<Ajuna.NetApi.Model.SpCore.AccountId32> _prev;
        
        /// <summary>
        /// >> next
        /// </summary>
        private BaseOpt<Ajuna.NetApi.Model.SpCore.AccountId32> _next;
        ...
        public Ajuna.NetApi.Model.SpCore.AccountId32 Id
        {
            get
            {
                return this._id;
        ...
        public BaseOpt<Ajuna.NetApi.Model.SpCore.AccountId32> Prev
        {
            get
            {
                return this._prev;
        ...
        public BaseOpt<Ajuna.NetApi.Model.SpCore.AccountId32> Next
        {
            get
            {
                return this._next;
        ...
        {
            var start = p;
            Id = new Ajuna.NetApi.Model.SpCore.AccountId32();
            Id.Decode(byteArray, ref p);
            Prev = new BaseOpt<Ajuna.NetApi.Model.SpCore.AccountId32>();
            Prev.Decode(byteArray, ref p);
            Next = new BaseOpt<Ajuna.NetApi.Model.SpCore.AccountId32>();
