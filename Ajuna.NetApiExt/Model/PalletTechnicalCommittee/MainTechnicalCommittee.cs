...
namespace Ajuna.NetApi.Model.PalletTechnicalCommittee
{
    ...
    public sealed class TechnicalCommitteeStorage
    {
        ...
        public TechnicalCommitteeStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalCommittee", "Members"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(BaseVec<Ajuna.NetApi.Model.SpCore.AccountId32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("TechnicalCommittee", "Prime"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.NetApi.Model.SpCore.AccountId32)));
        }
        ...
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.NodeRuntime.EnumNodeCall> ProposalOf(Ajuna.NetApi.Model.PrimitiveTypes.H256 key, CancellationToken token)
        {
            string parameters = TechnicalCommitteeStorage.ProposalOfParams(key);
            return await _client.GetStorageAsync<Ajuna.NetApi.Model.NodeRuntime.EnumNodeCall>(parameters, token);
        }
    ...
    public sealed class TechnicalCommitteeCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Execute(Ajuna.NetApi.Model.NodeRuntime.EnumNodeCall proposal, BaseCom<Ajuna.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Propose(BaseCom<Ajuna.NetApi.Model.Types.Primitive.U32> threshold, Ajuna.NetApi.Model.NodeRuntime.EnumNodeCall proposal, BaseCom<Ajuna.NetApi.Model.Types.Primitive.U32> length_bound)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
